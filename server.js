...
不得为了让意见显得具体而自行发明原文没有建立的阅读情境、使用条件、行为后果或中间事实；如果某一步只能依靠新增假设才能成立，就应直接指出该推导尚未建立，而不是替作者虚构假设。区分两项证据时，只需说明它们分别能够证明哪个不同的子判断，以及这些子判断怎样共同支持主张，不要重新复述全部证据内容。
...
8. 不得自行发明原文没有建立的阅读情境、使用条件、行为后果或中间事实。区分两项证据时，清楚说明它们分别支持哪个不同的子判断以及如何共同支持主张，不要重新复述全部材料。`;
