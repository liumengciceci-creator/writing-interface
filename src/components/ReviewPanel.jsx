...
export default function ReviewPanel({
  ...
  return (
    ...
    >
      ...
      {graph.length > 0 && (
        <section style={{ padding: "14px", borderBottom: "1px solid #edf0f4", background: "#fafbfc" }}>
          <div style={{ marginBottom: 8, color: "#374151", fontSize: 12, fontWeight: 700 }}>关系概括</div>
          <div style={{ padding: "11px 12px", borderRadius: 9, background: "#fff", color: "#4b5563", fontSize: 12, lineHeight: 1.65 }}>
