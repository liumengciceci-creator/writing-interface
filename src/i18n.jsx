...
const MESSAGES = {
  zh: {
    ...
    "app.reviewDoneChecks": "审阅完成：已完成 {count} 项论证检查",
    ...
    "review.close": "关闭审阅结果",
    "review.summary": "整体评价",
    "review.criteriaHeading": "模块关系检查",
    "review.titleGroup": "标题：",
    "review.paragraph": "第{count}段：",
    "review.checking": "正在检查…",
    "review.waitingResults": "正在识别需要检查的模块关系…",
    "review.passed": "该项检查通过",
    "review.skipped": "该建议已暂不处理",
    ...
    "review.replaceInstruction": "重构为{label}模块",
    "review.applying": "正在按指令修改…",
    "review.inserting": "正在添加并生成…",
    "review.replacing": "正在重构并生成…",
    "review.apply": "按此指令修改",
    "review.insert": "添加并生成",
    "review.replace": "重构并生成",
    "review.skip": "暂不修改",
  ...
  en: {
    ...
    "app.reviewDoneChecks": "Review complete: {count} argument checks completed",
    ...
    "review.overall": "Overall assessment",
    "review.result": "Review results",
    "review.close": "Close review results",
    "review.summary": "Overall assessment",
    "review.criteriaHeading": "Module relationship checks",
    "review.titleGroup": "Title:",
    "review.paragraph": "Paragraph {count}:",
    "review.checking": "Checking…",
    "review.waitingResults": "Identifying the module relationships that need checking…",
    "review.passed": "This check passed",
    "review.skipped": "This suggestion was left for later",
