...
const MESSAGES = {
  zh: {
    ...
    "review.waitingResults": "整体判断完成后，这里会逐项显示与当前内容相关的检查结果。",
  ...
  en: {
    ...
    "review.waitingResults": "After the overall assessment, results relevant to this content will appear here one by one.",
