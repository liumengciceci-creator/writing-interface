...
const MESSAGES = {
  zh: {
    ...
    "toolbar.review": "审阅",
    "toolbar.pauseGenerate": "暂停生成",
    "toolbar.pauseReview": "暂停审阅",
    "toolbar.complete": "完成",
    "toolbar.undo": "撤销",
    "toolbar.redo": "重做",
    "toolbar.generateTitle": "生成所选模块",
    "toolbar.pauseGenerateTitle": "暂停本轮生成并保留已经显示的内容",
    "toolbar.pauseReviewTitle": "暂停本轮审阅并保留已经返回的结果",
    ...
    "research.recording": "正在记录研究日志",
    "research.finishAndExport": "结束实验并导出日志",
    "research.ended": "本次实验记录已结束",
    "research.exported": "研究日志已提交并导出",
    "status.reviewing": "正在审阅模块关系...",
    "status.generating": "正在生成...",
    "status.resizing": "正在调整模块长度...",
    "generation.failureTitle": "生成失败",
    "generation.failureMessage": "刚才选择的 {count} 个模块未能完成生成，原内容已经保留。",
    "generation.retry": "重试",
    "generation.dismiss": "关闭",
    ...
    "app.busyStyling": "正在根据指令修改模块，请等待当前操作完成。",
    "app.busyRevising": "正在处理模块内容，请等待当前操作完成。",
    "app.generationPaused": "生成已暂停，已保留当前内容。",
    "app.reviewPaused": "审阅已暂停，已保留当前结果。",
    ...
    "review.applying": "正在根据审阅建议修改模块…",
    "review.inserting": "正在根据审阅建议添加并生成模块…",
  ...
  en: {
    ...
    "toolbar.pauseGenerate": "Pause generation",
    "toolbar.pauseReview": "Pause review",
    "toolbar.complete": "Complete",
    "toolbar.undo": "Undo",
    "toolbar.redo": "Redo",
    "toolbar.generateTitle": "Generate selected modules",
    "toolbar.pauseGenerateTitle": "Pause this generation and keep the content already shown",
    "toolbar.pauseReviewTitle": "Pause this review and keep the results already returned",
    ...
    "research.recording": "Research logging active",
    "research.finishAndExport": "Finish study and export log",
    "research.ended": "Study session ended",
    "research.exported": "Research log submitted and exported",
    "status.reviewing": "Reviewing module relationships...",
    "status.generating": "Generating...",
    "status.resizing": "Adjusting module length...",
    "generation.failureTitle": "Generation failed",
    "generation.failureMessage": "The {count} previously selected modules could not be generated. Their original content was preserved.",
    "generation.retry": "Retry",
    "generation.dismiss": "Close",
    ...
    "app.busyStyling": "A module is being revised from an instruction. Please wait for the current action to finish.",
    "app.busyRevising": "Module content is being processed. Please wait for the current action to finish.",
    "app.generationPaused": "Generation paused. Current content has been kept.",
    "app.reviewPaused": "Review paused. Current results have been kept.",
    ...
    "review.applying": "Revising the module from the review suggestion…",
    "review.inserting": "Adding and generating a module from the review suggestion…",
    ...
    "quickInstruction.stop": "Stop generating",
    ...
    "contextMenu.restorePrevious": "Restore previous version",
    "contextMenu.editText": "Edit text",
